...
public class DownloadAndPlaySound {
	...
	public double native_daps_init(String tag, String url) {
		this.tag = tag;
		this.url = url;
	...
	public double native_daps_ready_audio(String filename) {
		
        String folderPath = Environment.getExternalStorageDirectory() + "/" + tag + "/gamesound/";
        ...
        if (isValid == true) {
			...
			RunnerJNILib.DsMapAddString(dsMapIndex, "type", "__SOUND_READY");
            ...
            new DownloadTask().execute(url + "ogg/" + filename + ".ogg", filename);
        }

        return -1;
	}

	public String native_daps_create_uuid() {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                if (connection.getResponseCode() == HttpURLConnection.HTTP_OK) {
                	...
                	String path = Environment.getExternalStorageDirectory() + "/" + tag + "/gamesound/" + args[1];
